...
const Hero = () => {
  return (
    <div id='hero' className='flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white'>
      ...
      <div className="inline-flex items-center gap-2 border border-grau-300 p-1.5 pr-4 rounded-full">
        <img src={assets.group_profile} alt="" className='w-20'/>
        <p className='text-xs font-medium'>Trusted by 10k peoples</p>
      </div>
      ...
      <p className='text-sm sm:text-lg font-medium text-gray-500 dark:text-white/75 max-w-4/5 sm:max-w-lg pb-3'>Craeting meaningful connections and turning big ideas into intractive digital experiences.</p>
